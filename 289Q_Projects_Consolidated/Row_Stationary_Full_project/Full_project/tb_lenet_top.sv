...
module tb_lenet_top;
    ...
    task automatic clear_accelerator_memories();
        ...
        // Clear IFMAP memories so Fmstale values can't affect subsequent images.
    ...
    initial begin
        ...
        load_conv1_weights("C:/Users/dnare/Downloads/Row_Stationary_Full_project/Full_project/conv1_weights.hex");

        load_conv2_weights("C:/Users/dnare/Downloads/Row_Stationary_Full_project/Full_project/conv2_weights.hex");
        ...
        for (run_idx = 0; run_idx < num_runs; run_idx = run_idx + 1) begin
            ...
            load_mnist_binary("C:/Users/dnare/Downloads/Row_Stationary_Full_project/Full_project/t10k-images-idx3-ubyte", img_idx);

            load_mnist_label("C:/Users/dnare/Downloads/Row_Stationary_Full_project/Full_project/t10k-labels-idx1-ubyte", img_idx, expected_label);
