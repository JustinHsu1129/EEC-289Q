...
module pooling_top #(
    ...
    // EXPOSED CHANNEL INDICES
    output logic [$clog2(CHANNELS)-1:0] ch,
    output logic [$clog2(CHANNELS)-1:0] ch_write
);
    ...
    // Properly sized logic signals for row/col base
    logic [4:0] r0;
    logic [4:0] c0;

    always_comb begin
        r0 = {out_r, 1'b0}; // multiply by 2
        c0 = {out_c, 1'b0}; // multiply by 2
