...
module model_top_tb;
    ...
    initial begin
        ...
        for (run_idx = 0; run_idx < num_runs; run_idx = run_idx + 1) begin
            ...
            load_mnist_binary("C:/Users/dnare/Desktop/Full_project_IP/t10k-images-idx3-ubyte", img_idx);
            load_mnist_label("C:/Users/dnare/Desktop/Full_project_IP/t10k-labels-idx1-ubyte", img_idx, expected_label);
