...
module model_top_tb;
    ...
    initial begin
        ...
        // 1. Load weights once (shared across all runs)
			...
			load_conv1_weights("C:/Users/dnare/Downloads/Output_Stationary_Full_project/Full_project/conv1_weights.hex");
			load_conv2_weights("C:/Users/dnare/Downloads/Output_Stationary_Full_project/Full_project/conv2_weights.hex");
        ...
        for (run_idx = 0; run_idx < num_runs; run_idx = run_idx + 1) begin
            ...
            load_mnist_binary("C:/Users/dnare/Downloads/Output_Stationary_Full_project/Full_project/t10k-images-idx3-ubyte", img_idx);
            load_mnist_label("C:/Users/dnare/Downloads/Output_Stationary_Full_project/Full_project/t10k-labels-idx1-ubyte", img_idx, expected_label);
