...
assign OutputFeatureMapWriteEnableOut = WeightMacEnableOut;

assign WeightAddressComb = WeightAddressBit'(32'(ReductionCounter) * NumOutTile + 32'(OutChannelTile));
assign InputFeatureMapAddressOut = InputFeatureMapAddressBit'(32'(OutputPixelCounter) * ReductionSteps + 32'(ReductionCounter));
assign OutputFeatureMapAddressComb = OutputFeatureMapAddressBit'(32'(OutputPixelCounter) * NumOutTile + 32'(OutChannelTile));
...
always_ff @(posedge Clock) begin
    if (~ResetNegative) begin
        ...
        case (State)
            ...
            DRAIN: begin
                if (32'(DrainCounter) == DrainCycles - 1) begin
