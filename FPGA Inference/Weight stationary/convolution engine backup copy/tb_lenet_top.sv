// iverilog -g2012 -o sim FIFO.sv Mem_ctrl.sv PE_Array.sv PE.sv Systolic_Top.sv tb_lenet_top.sv

`timescale 1ns / 1ps

module tb_lenet_top();

parameter int PeArrayRows = 8; // Physical PE rows
parameter int PeArrayColumns = 8;
// Physical PE columns
parameter int WeightBitWidth = 8;
parameter int InputFeatureMapBitWidth = 16;
parameter int OutputFeatureMapBitWidth = 32;
parameter int OutputFeatureMapChannelCount = 2; // Logical output channels
parameter int InputFeatureMapChannelCount = 1;
// Logical input channels
parameter int WeightWidth = 64;
parameter int WeightHeight = 64;
parameter int InputFeatureMapWidth = 640;
parameter int InputFeatureMapHeight = 480;
parameter int OutputFeatureMapWidth = 577;
parameter int OutputFeatureMapHeight = 417;
