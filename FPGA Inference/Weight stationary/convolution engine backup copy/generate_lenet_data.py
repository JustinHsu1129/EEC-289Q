...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--height", type=int, default=480, help="Input feature-map height.")
    parser.add_argument("--width", type=int, default=640, help="Input feature-map width.")
    parser.add_argument("--in-channels", type=int, default=1, help="Logical input channels.")
    parser.add_argument("--out-channels", type=int, default=1, help="Logical output channels.")
    parser.add_argument("--kernel-height", type=int, default=64, help="Kernel height.")
    parser.add_argument("--kernel-width", type=int, default=64, help="Kernel width.")
